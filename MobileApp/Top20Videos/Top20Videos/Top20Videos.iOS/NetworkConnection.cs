...
namespace Top20Videos.iOS
{
    public class NetworkConnection : INetworkConnection
    {
        ...
        {
            IsConnected = Reachability.IsHostReachable(Reachability.HostName);
        }
    }

    public static class Reachability
    {
        public static string HostName = Top20Videos.Helpers.ApplicationConstant.Api_CategoryUrl;
